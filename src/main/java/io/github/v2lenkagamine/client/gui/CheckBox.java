...
//Yo check out this SICK gui element I stole from MrCrayfish!
//AND THE PNG TOO(Well, the first 2 elements, if I ever add to it...
@OnlyIn(Dist.CLIENT)
public class CheckBox extends AbstractWidget{
	 private static final ResourceLocation GUI = new ResourceLocation("lensrandoms:textures/gui/components.png");
